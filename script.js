...
function renderProfitReports() {
    ...
    // تأكد من تحميل أحدث بيانات المبيعات من التخزين (حماية من أي إعادة تهيئة في الذاكرة)
...
const translations = {
    ar: {
        ...
        'quantity': 'الكمية',
        'cost-per-unit': 'التكلفة/وحدة',
        'add-item': 'إضافة صنف',
        'notes': 'ملاحظات',
        'additional-notes': 'ملاحظات إضافية...',
        'total': 'الإجمالي',
        'save-invoice': 'حفظ الفاتورة',
        'added-to-cart': 'تم إضافة {product} إلى العربة',
        'removed-from-cart': 'تم حذف {product} من العربة',
        'product-removed-from-cart': 'تم حذف المنتج من العربة',
        'cart-cleared': 'تم مسح العربة',
        'all-prices-updated': 'تم تحديث جميع الأسعار في العربة',
        'products-updated': 'تم تحديث {count} منتج في العربة',
        'pos-updated': 'تم تحديث نقطة البيع بنجاح',
        'product-added': 'تم إضافة المنتج بنجاح',
        'product-updated': 'تم تحديث المنتج بنجاح',
        'product-deleted': 'تم حذف المنتج',
        'customer-added': 'تم إضافة العميل بنجاح',
        'customer-updated': 'تم تحديث العميل بنجاح',
        'supplier-added': 'تم إضافة المورد بنجاح',
        'supplier-updated': 'تم تحديث المورد بنجاح',
        'supplier-deleted': 'تم حذف المورد',
        'purchase-invoice-saved': 'تم حفظ فاتورة الشراء',
        'purchase-invoice-created': 'تم إنشاء فاتورة الشراء {invoice} بنجاح',
        'purchase-returned': 'تم تسجيل إرجاع الشراء',
        'exchange-rate-updated': 'تم تحديث سعر الصرف بنجاح',
        'data-exported': 'تم تصدير البيانات بنجاح',
        'barcode-generated': 'تم إنشاء باركود تلقائي بنجاح!',
        'barcode-printing': 'تم بدء طباعة {quantity} باركود!',
        'cash-move-recorded': 'تم تسجيل حركة الصندوق',
        'store-info-saved': 'تم حفظ معلومات المتجر',
        'setting-saved': 'تم حفظ الإعداد بنجاح',
        'filter-applied': 'تم تطبيق التصفية: {count} معاملة',
        'filter-reset': 'تم إعادة تعيين الفلترة',
        'transactions-found': 'تم العثور على {count} معاملة في الفترة المحددة',
        'product-added-by-barcode': 'تم إضافة {product} إلى العربة بالباركود',
        'product-not-found-barcode': 'لم يتم العثور على منتج بالباركود: {barcode}',
        'previous-account-exists': 'تم إضافة حساب هذا العميل السابق مسبقاً',
        'previous-account-added': 'تم إضافة حساب سابق بقيمة {amount}',
        'invoice-not-found': 'لم يتم العثور على الفاتورة',
        'sale-returned': 'تم استرجاع المبيعة بنجاح! تم رد {amount} للعميل',
        'small': 'صغير',
        'medium': 'متوسط',
        'large': 'كبير',
        'print': 'طباعة',
    ...
    en: {
        ...
        'removed-from-cart': 'Removed {product} from cart',
        'product-removed-from-cart': 'Product removed from cart',
        'cart-cleared': 'Cart cleared',
        'all-prices-updated': 'All cart prices updated',
        'products-updated': 'Updated {count} products in cart',
        'pos-updated': 'Point of Sale updated successfully',
        ...
        'purchase-invoice-saved': 'Purchase invoice saved',
        'purchase-invoice-created': 'Purchase invoice {invoice} created successfully',
        'purchase-returned': 'Purchase return recorded',
        'exchange-rate-updated': 'Exchange rate updated successfully',
        'data-exported': 'Data exported successfully',
        'barcode-generated': 'Barcode generated successfully!',
        'barcode-printing': 'Started printing {quantity} barcodes!',
        'cash-move-recorded': 'Cash movement recorded',
        'store-info-saved': 'Store information saved',
        'setting-saved': 'Setting saved successfully',
        'filter-applied': 'Filter applied: {count} transactions',
        'filter-reset': 'Filter reset',
        'transactions-found': 'Found {count} transactions in the specified period',
        'product-added-by-barcode': 'Added {product} to cart by barcode',
        'product-not-found-barcode': 'Product not found with barcode: {barcode}',
        'previous-account-exists': 'Previous account for this customer already added',
        'previous-account-added': 'Previous account added with value {amount}',
        'invoice-not-found': 'Invoice not found',
        'sale-returned': 'Sale returned successfully! Refunded {amount} to customer',
        'small': 'Small',
        'medium': 'Medium',
        'large': 'Large',
        'print': 'Print',
...
function getText(key, replacements = {}) {
    ...
    // Replace placeholders like {product}, {count}, etc.
...
function changeLanguage(lang) {
    ...
    // إصلاح ترتيب عناوين جدول الموردين بعد تغيير اللغة
    setTimeout(() => {
        fixSuppliersTableHeaders();
    }, 100);
    
    // إصلاح ترتيب عناوين جدول الموردين مرة أخرى
    setTimeout(() => {
        fixSuppliersTableHeaders();
    }, 200);
...
function openSupplierPayment() {
    ...
    const renderList = (term='') => {
        ...
        if (filtered.length === 0) {
            ...
            list.innerHTML = filtered.map(s=>`<div class="sp-supplier-item" data-id="${s.id}"><span>${s.name}</span><span class="phone">${s.phone||''}</span></div>`).join('');
        }
...
function saveToStorage(key, data) {
    try {
        // استخدام IndexedDB للمفاتيح الكبيرة
        const isLargeKey = Array.isArray(window.LARGE_STORAGE_KEYS) && window.LARGE_STORAGE_KEYS.includes(key);
        if (isLargeKey) {
            assignLargeKeyInMemory(key, data);
            // حفظ في IDB وإزالة النسخة الثقيلة من localStorage
            idbSet(key, data).then(() => {
                try { localStorage.removeItem(key); } catch(_) {}
                try { localStorage.setItem(`${key}.meta`, 'idb'); } catch(_) {}
            }).catch(e => console.warn('idbSet async error:', e));
            return true;
        }
        ...
        // معالجة امتلاء المساحة تلقائياً
        try {
            if (error && (error.name === 'QuotaExceededError' || error.code === 22 || error.code === 1014)) {
                console.warn('⚠️ سعة التخزين ممتلئة - بدء ضغط البيانات...');
                const compactOnce = () => {
                    // إزالة مفاتيح غير حرجة
                    const optionalKeys = [
                        'sales_backup','productsLastUpdated','productsCatalogVersion',
                        'ui.scale','inventoryPaginationState','productsPaginationState','salesPaginationState',
                        'profit.pageSize','capital.pageSize','lastCartFocusIndex'
                    ];
                    optionalKeys.forEach(k => { try { localStorage.removeItem(k); } catch(_) {} });
                    
                    // تقليص سجلات الصندوق
                    try {
                        const cd = loadFromStorage('cashDrawer', null);
                        if (cd && Array.isArray(cd.transactions) && cd.transactions.length > 500) {
                            cd.transactions = cd.transactions.slice(-500);
                            localStorage.setItem('cashDrawer', JSON.stringify(cd));
                        }
                    } catch(_) {}
                    
                    // تقليص حركات المخزون
                    try {
                        const sm = loadFromStorage('stockMovements', []);
                        if (Array.isArray(sm) && sm.length > 1000) {
                            localStorage.setItem('stockMovements', JSON.stringify(sm.slice(-1000)));
                        }
                    } catch(_) {}
                    
                    // تقليص سجلات المبيعات
                    try {
                        const sl = loadFromStorage('salesLogs', []);
                        if (Array.isArray(sl) && sl.length > 2000) {
                            localStorage.setItem('salesLogs', JSON.stringify(sl.slice(-2000)));
                        }
                    } catch(_) {}
                    
                    // تقليص سجلات العملاء
                    try {
                        const cl = loadFromStorage('customerLogs', {});
                        if (cl && typeof cl === 'object') {
                            ...
                            localStorage.setItem('customerLogs', JSON.stringify(cl));
                        }
                    } catch(_) {}
                };
                
                const compactAggressive = () => {
                    // مراحل أكثر تشدداً
                    try {
                        const cd = loadFromStorage('cashDrawer', null);
                        if (cd && Array.isArray(cd.transactions) && cd.transactions.length > 200) {
                            cd.transactions = cd.transactions.slice(-200);
                            localStorage.setItem('cashDrawer', JSON.stringify(cd));
                        }
                    } catch(_) {}
                    try {
                        const sm = loadFromStorage('stockMovements', []);
                        if (Array.isArray(sm) && sm.length > 400) {
                            localStorage.setItem('stockMovements', JSON.stringify(sm.slice(-400)));
                        }
                    } catch(_) {}
                    try {
                        const sl = loadFromStorage('salesLogs', []);
                        if (Array.isArray(sl) && sl.length > 500) {
                            localStorage.setItem('salesLogs', JSON.stringify(sl.slice(-500)));
                        }
                    } catch(_) {}
                };
                ...
                try {
                    localStorage.setItem(key, JSON.stringify(data));
                    console.warn('✅ تم الحفظ بعد ضغط البيانات (المرحلة 1).');
                    return true;
                } catch (e2) {
                    console.warn('المرحلة 1 لم تكفِ، سيتم ضغط إضافي...', e2);
                }
                
                // محاولة 2: ضغط أكثر شدة
                compactAggressive();
                try {
                    localStorage.setItem(key, JSON.stringify(data));
                    console.warn('✅ تم الحفظ بعد ضغط البيانات (المرحلة 2).');
                    return true;
                } catch (e3) {
                    console.error('❌ فشل الحفظ بعد محاولات الضغط:', e3);
                    try { showMessage('⚠️ مساحة التخزين ممتلئة. يرجى تصدير البيانات ثم مسح السجلات غير المهمة (سجل الصندوق/الحركات/السجلات) لتفريغ مساحة.', 'error'); } catch(_) {}
                    return false;
                }
            }
        } catch(_) {}
...
// ===== تخزين دائم عبر IndexedDB لحل مشكلة امتلاء localStorage =====
let __posDbPromise = null;
// تعريف المفاتيح الكبيرة بشكل آمن ومبكر
window.LARGE_STORAGE_KEYS = window.LARGE_STORAGE_KEYS || ['sales', 'salesLogs', 'stockMovements', 'cashDrawer'];
const LARGE_STORAGE_KEYS = window.LARGE_STORAGE_KEYS;
const __largeCache = {};

function initIndexedDB() {
    if (__posDbPromise) return __posDbPromise;
    __posDbPromise = new Promise((resolve, reject) => {
        try {
            const req = indexedDB.open('catch_pos_db', 1);
...
function assignLargeKeyInMemory(key, data) {
    if (data == null) return;
    __largeCache[key] = data;
    try {
        switch (key) {
            case 'sales':
                ...
                break;
            case 'salesLogs':
                // لا تستخدم مباشرة في كل مكان، يكفي الكاش
                break;
            case 'stockMovements':
                // لا شيء مطلوب الآن
                break;
            case 'cashDrawer':
                cashDrawer = (data && typeof data === 'object') ? data : cashDrawer;
                break;
        }
    } catch (_) {}
}

async function migrateLargeKeysToIDB() {
    try {
        await initIndexedDB();
        for (const key of (window.LARGE_STORAGE_KEYS || [])) {
            try {
                const dataStr = localStorage.getItem(key);
                if (dataStr) {
                    const data = JSON.parse(dataStr);
                    await idbSet(key, data);
                    // اترك فقط ميتا صغيرة للدلالة على أن البيانات موجودة في الـ DB
                    localStorage.removeItem(key);
                    localStorage.setItem(`${key}.meta`, 'idb');
                    assignLargeKeyInMemory(key, data);
                } else {
                    // حاول التحميل من IDB إلى الذاكرة عند عدم وجود نسخة محلية
        ...
        // تحديث واجهات حرجة بعد التحميل
        try { updateCashDrawerDisplay(); } catch(_) {}
        try { if (document.getElementById('sales')?.classList.contains('active')) loadSales(); } catch(_) {}
    } catch (e) {
        console.warn('migrateLargeKeysToIDB error:', e);
    }
}

// تشغيل التمهيد عند التحميل
document.addEventListener('DOMContentLoaded', function() {
    migrateLargeKeysToIDB();
});

// ====== (اختياري) طبقة SQLite (sql.js) للتخزين كبنية قاعدة بيانات ======
let __sqlite = null;
let __sqliteReady = false;
...
async function initSqliteBackend() {
    try {
        // تحميل sql.js من CDN
        await loadScript(`https://cdnjs.cloudflare.com/ajax/libs/sql.js/${SQL_JS_VERSION}/sql-wasm.js`);
        if (!window.initSqlJs) {
            console.warn('sql.js not available; skipping SQLite backend.');
            return;
        }
        const SQL = await window.initSqlJs({
            locateFile: (file) => `https://cdnjs.cloudflare.com/ajax/libs/sql.js/${SQL_JS_VERSION}/${file}`
        });
        // محاولة تحميل قاعدة موجودة من IndexedDB
        const existing = await idbGet('sqlite_db');
        __sqlite = existing ? new SQL.Database(existing) : new SQL.Database();
        ...
        `);
        __sqliteReady = true;
        // ترحيل أولي من IDB إذا لم يُنفّذ سابقاً
        try {
            const migrated = localStorage.getItem('sqlite.migrated.sales');
            if (migrated !== '1') {
                const existingSales = loadFromStorage('sales', []);
                if (Array.isArray(existingSales) && existingSales.length > 0) {
                    const stmt = __sqlite.prepare(`INSERT OR REPLACE INTO sales 
                        (id, invoiceNumber, timestamp, date, customer, amount, paymentMethod, json) 
                        VALUES (?, ?, ?, ?, ?, ?, ?, ?);`);
                    existingSales.forEach(sale => {
                        const rid = String(sale.id || sale.invoiceNumber || cryptoRandomId());
                        const inv = String(sale.invoiceNumber || `INV-${rid}`);
                        const ts = String(sale.timestamp || getLocalDateTimeISO());
                        const d = String(sale.date || (ts.split('T')[0]));
                        const cust = String(sale.customer || sale.customerName || 'عميل عادي');
                        const amt = Number(sale.amount) || 0;
                        const pm = String(sale.paymentMethod || 'نقدي');
                        const json = JSON.stringify(sale.items || []);
                        stmt.run([rid, inv, ts, d, cust, amt, pm, json]);
                    });
                    stmt.free();
                    await persistSqliteDb();
                    localStorage.setItem('sqlite.migrated.sales', '1');
                }
            }
        } catch (e) { console.warn('SQLite migrate sales error:', e); }
        console.log('SQLite backend ready.');
    } catch (e) {
        console.warn('initSqliteBackend failed:', e);
    }
}
...
async function persistSqliteDb() {
    try {
        if (!__sqlite) return;
        const binary = __sqlite.export();
        await idbSet('sqlite_db', binary);
    } catch (e) {
        console.warn('persistSqliteDb error:', e);
    }
}

function sqliteSaveSale(sale) {
    if (!__sqliteReady || !__sqlite) return;
    try {
        const rid = String(sale.id || sale.invoiceNumber || cryptoRandomId());
        const inv = String(sale.invoiceNumber || `INV-${rid}`);
        const ts = String(sale.timestamp || getLocalDateTimeISO());
        ...
        console.warn('sqliteSaveSale error:', e);
    }
}

function loadSalesFromSqlite(limit = null) {
    if (!__sqliteReady || !__sqlite) return null;
    try {
        const q = limit 
            ? `SELECT * FROM sales ORDER BY timestamp DESC LIMIT ${Number(limit)}` 
            : `SELECT * FROM sales ORDER BY timestamp DESC`;
        const res = __sqlite.exec(q);
        ...
        return res[0].values.map(row => {
            ...
            // إعادة تشكيل العناصر
            try { o.items = JSON.parse(o.json || '[]'); } catch(_) { o.items = []; }
            delete o.json;
            return o;
        });
    } catch (e) {
        console.warn('loadSalesFromSqlite error:', e);
        return [];
    }
}

// بدء محرك SQLite بعد الإقلاع
document.addEventListener('DOMContentLoaded', function() {
    initSqliteBackend();
});

// ===== Supabase Cloud Backend (configurable) =====
let __supabase = null;
function initSupabaseFromLocal() {
    try {
        ...
        if (url && key && window.supabase) {
            __supabase = window.supabase.createClient(url, key, { auth: { persistSession: false } });
            console.log('Supabase client initialized.');
        }
    } catch (e) {
        console.warn('initSupabaseFromLocal error:', e);
    }
}
function setSupabaseConfig(url, anonKey) {
    try { localStorage.setItem('supabase.url', url); } catch(_) {}
    try { localStorage.setItem('supabase.anonKey', anonKey); } catch(_) {}
    initSupabaseFromLocal();
}
function cloudEnabled() { return !!__supabase; }
async function cloudSaveSale(sale) {
    try {
        if (!cloudEnabled()) return false;
        // جدول: sales (id TEXT PK, invoice_number TEXT, timestamp TEXT, date TEXT, customer TEXT, amount REAL, payment_method TEXT, items JSONB)
        const payload = {
            id: String(sale.id || sale.invoiceNumber),
            invoice_number: sale.invoiceNumber,
            timestamp: sale.timestamp,
            date: sale.date,
            customer: sale.customer || sale.customerName || 'عميل عادي',
            amount: Number(sale.amount) || 0,
            payment_method: sale.paymentMethod || 'نقدي',
            items: sale.items || []
        };
        const { error } = await __supabase.from('sales').upsert(payload, { onConflict: 'id' });
        if (error) { console.warn('cloudSaveSale error:', error); return false; }
        return true;
    } catch (e) {
        console.warn('cloudSaveSale exception:', e);
        return false;
    }
}
async function cloudLoadSales(limit = null) {
    try {
        if (!cloudEnabled()) return null;
        let query = __supabase.from('sales').select('*').order('timestamp', { ascending: false });
        if (limit) query = query.limit(Number(limit));
        const { data, error } = await query;
        if (error) { console.warn('cloudLoadSales error:', error); return []; }
        return (data || []).map(r => ({
            id: r.id,
        ...
        console.warn('cloudLoadSales exception:', e);
        return [];
    }
}
// init on load
document.addEventListener('DOMContentLoaded', initSupabaseFromLocal);

// إعداد حقول إعدادات Supabase في صفحة الإعدادات
document.addEventListener('DOMContentLoaded', function() {
    try {
        ...
        if (urlInput) urlInput.value = localStorage.getItem('supabase.url') || '';
        if (keyInput) keyInput.value = localStorage.getItem('supabase.anonKey') || '';
        ...
        if (saveBtn) {
            saveBtn.addEventListener('click', function() {
                ...
                if (!url || !key) {
                    showMessage('يرجى إدخال URL و Key', 'error');
                    return;
                }
                setSupabaseConfig(url, key);
                if (statusEl) { statusEl.style.color = '#059669'; statusEl.textContent = 'تم الحفظ. جاهز للسحابة.'; }
                showMessage('✅ تم حفظ إعدادات Supabase', 'success');
            });
        }
        
        if (testBtn) {
            testBtn.addEventListener('click', async function() {
                if (!cloudEnabled()) { showMessage('Supabase غير مهيّأ', 'error'); return; }
                if (statusEl) { statusEl.style.color = '#6b7280'; statusEl.textContent = 'جار الاختبار...'; }
                try {
                    const rows = await cloudLoadSales(1);
                    if (Array.isArray(rows)) {
                        if (statusEl) { statusEl.style.color = '#059669'; statusEl.textContent = 'الاتصال ناجح ✔'; }
                        showMessage('✅ الاتصال بالسحابة ناجح', 'success');
                    } else {
                        if (statusEl) { statusEl.style.color = '#b91c1c'; statusEl.textContent = 'فشل الاختبار'; }
                        showMessage('فشل الاختبار', 'error');
                    }
                } catch (e) {
                    if (statusEl) { statusEl.style.color = '#b91c1c'; statusEl.textContent = 'فشل: ' + (e?.message || e); }
                    showMessage('فشل الاختبار: ' + (e?.message || e), 'error');
                }
            });
        }
    } catch (e) {
        console.warn('Supabase settings UI init failed:', e);
    }
});

// حفظ آمن وموحّد لأي عملية بيع (نقدي/جزئي/دين/مرتجع)
function secureSaveSale(sale, opts = {}) {
    try {
        const options = opts || {};
        // تأكيد وجود مصفوفة المبيعات
        if (!Array.isArray(sales)) sales = loadFromStorage('sales', []) || [];
        // ضمان هوية فريدة
        if (!sale.id) {
        ...
        // ضمان رقم الفاتورة
        if (!sale.invoiceNumber) {
            sale.invoiceNumber = `INV-${String(sales.length + 1).padStart(3, '0')}`;
        }
        // ضمان التاريخ والوقت المحليين
        const ts = sale.timestamp && String(sale.timestamp).includes('T') ? sale.timestamp : getLocalDateTimeISO();
        sale.timestamp = ts;
        if (!sale.date) {
            const dateOnly = ts.split('T')[0];
            sale.date = dateOnly;
        }
        // توحيد العميل وطريقة الدفع
        sale.customer = sale.customer || sale.customerName || (getText && getText('regular-customer')) || 'عميل عادي';
        sale.paymentMethod = sale.paymentMethod || 'نقدي';
        // ضمان بنود الفاتورة
        ...
        // حفظ نسخة احتياطية خفيفة (آخر 100 فقط)
        try { 
            const backup = loadFromStorage('sales_backup', []);
            const slim = { id: sale.id, invoiceNumber: sale.invoiceNumber, timestamp: sale.timestamp, amount: sale.amount };
            const next = Array.isArray(backup) ? [...backup, slim].slice(-100) : [slim];
            localStorage.setItem('sales_backup', JSON.stringify(next)); 
        } catch(_) {}
        // تسجيل في سجل المبيعات العام
        try {
        ...
        // حفظ أيضاً في SQLite إن كانت جاهزة
        try { if (__sqliteReady && __sqlite) sqliteSaveSale(sale); } catch(_) {}
        // حفظ إلى السحابة إن مفعّل
        try { if (cloudEnabled()) cloudSaveSale(sale); } catch(_) {}
        return sale;
    } catch (e) {
        console.error('secureSaveSale error:', e, sale);
        // محاولة إنقاذ: حفظ الحد الأدنى في التخزين المباشر
        try {
            const minimal = sales || [];
            minimal.push(sale);
            localStorage.setItem('sales', JSON.stringify(minimal));
        } catch(_) {}
        return sale;
    }
}

// helper: الحصول على أحدث بيانات المبيعات من التخزين بشكل آمن
function getCurrentSales() {
    try {
        // Cloud أولاً إن توفر
        if (cloudEnabled()) {
            // ملاحظة: الاستدعاء غير متزامن، لذا نُعيد آخر نسخة محلية فوراً ونحدّث لاحقاً
            cloudLoadSales().then(rows => {
                if (Array.isArray(rows) && rows.length) {
                    assignLargeKeyInMemory('sales', rows);
                    try { saveToStorage('sales', rows); } catch(_) {}
                    try { if (document.getElementById('sales')?.classList.contains('active')) loadSales(); } catch(_) {}
                }
            });
        }
        // إذا كانت SQLite جاهزة، اجلب مباشرةً منها
        if (__sqliteReady && __sqlite) {
            const rows = loadSalesFromSqlite();
            if (rows && rows.length) return rows;
        }
        const data = loadFromStorage('sales', []);
        if (Array.isArray(data)) return data;
    } catch(_) {}
    // fallback: محاولة إعادة بناء بيانات مبيعات من السجل إن لم تتوفر
    try {
        const logs = loadFromStorage('salesLogs', []);
        if (Array.isArray(logs) && logs.length > 0) {
            const reconstructed = logs
                .filter(l => l && l.invoiceNumber && l.invoiceNumber !== '-' && typeof l.amount !== 'undefined')
                .map((l, idx) => {
                    const ts = l.timestamp || getLocalDateTimeISO();
                    // تحليل تاريخ محلي من timestamp
                    let dateOnly;
                    try {
                        if (typeof ts === 'string' && ts.includes('T')) {
                            dateOnly = ts.split('T')[0];
                        } else {
                            const d = new Date(ts);
                    ...
                    return {
                        ...
                        timestamp: ts,
                        date: dateOnly,
                        customer: l.customer || getText('regular-customer') || 'عميل عادي',
                        customerId: null,
                        amount: Number(l.amount) || 0,
                        paymentMethod: l.method || 'نقدي',
                        items: []
                    };
                });
...
function loadFromStorage(key, defaultValue = null) {
    try {
        // للمفاتيح الكبيرة: حاول أولاً من الكاش ثم من localStorage كتراث، ثم حمّل من IDB في الخلفية
        const isLargeKey = Array.isArray(window.LARGE_STORAGE_KEYS) && window.LARGE_STORAGE_KEYS.includes(key);
        if (isLargeKey) {
            if (__largeCache.hasOwnProperty(key)) {
                return __largeCache[key];
            }
            const legacy = localStorage.getItem(key);
            if (legacy) {
                try {
                    const parsed = JSON.parse(legacy);
                    // ابدأ الترحيل في الخلفية
                    idbSet(key, parsed).then(()=> {
                        assignLargeKeyInMemory(key, parsed);
                        try { localStorage.removeItem(key); localStorage.setItem(`${key}.meta`, 'idb'); } catch(_) {}
                    });
                    return parsed ?? defaultValue;
                } catch(_) {}
            }
            // تحميل غير متزامن من IDB وتحديث الذاكرة
            idbGet(key).then(data => {
                if (data != null) {
                    assignLargeKeyInMemory(key, data);
                    try { localStorage.setItem(`${key}.meta`, 'idb'); } catch(_) {}
                    // تحديث الواجهات عند الحاجة
                    try {
                        if (key === 'cashDrawer') updateCashDrawerDisplay();
                        if (key === 'sales' && document.getElementById('sales')?.classList.contains('active')) loadSales();
                    } catch(_) {}
                }
            });
            return defaultValue;
...
function rebuildCartWithNewPrices() {
    ...
    showMessage(getText('all-prices-updated'), 'success');
}
...
function forceUpdateCartPrices() {
    ...
    if (updatedCount > 0) {
        ...
        showMessage(getText('products-updated', { count: updatedCount }), 'success');
    } else {
...
function forceRefreshPOS() {
    ...
    try {
        ...
        showMessage(getText('pos-updated'), 'success');
...
function exportData() {
    ...
    showMessage(getText('data-exported'));
}
    ...
    tbody.innerHTML = purchases.slice().sort((a,b)=> new Date(b.date) - new Date(a.date)).map(p => {
        ...
        <tr>
            ...
            <td>
                ...
                <button class="action-btn" onclick="printExistingPurchaseInvoice(${p.id})" style="background-color: #28a745;"><i class="fas fa-print"></i> طباعة</button>
            </td>
        </tr>`;
    }).join('');
...
function confirmPurchaseReturn(billId) {
    ...
    showMessage(getText('purchase-returned'));
}
...
function openPurchase(purchaseId) {
    ...
    if (supplierSel) {
        supplierSel.innerHTML = `<option value="">${(document.documentElement.lang||'ar')==='en' ? 'Select supplier' : 'اختر المورد'}</option>` + suppliers.map(s=>`<option value="${s.id}">${s.name}</option>`).join('');
        // تحديث قائمة الموردين مع خاصية البحث
        updateSuppliersDropdown('purchaseSupplier');
    }
    ...
    if (printBtn) printBtn.onclick = () => printPurchaseInvoice();
...
function printPurchaseInvoice() {
    ...
    const printHTML = `
        ...
        <body>
            <div class="header">
                <div class="store-name">${settings.storeName || 'المحل'}</div>
                <div class="invoice-title">فاتورة شراء</div>
            </div>
            
            <div class="invoice-info">
                <div><strong>رقم الفاتورة:</strong> ${Math.max(0, ...purchases.map(p=>p.id)) + 1}</div>
                <div><strong>التاريخ:</strong> ${new Date(date).toLocaleDateString('ar-SA', { calendar: 'gregory' })}</div>
                ${dueDate ? `<div><strong>تاريخ الاستحقاق:</strong> ${new Date(dueDate).toLocaleDateString('ar-SA', { calendar: 'gregory' })}</div>` : ''}
            </div>
            ...
            <table class="items-table">
                ...
                <tbody>
                    ${items.map(item => {
                        ...
                        return `
                            <tr>
                                <td>${product ? product.name : 'منتج غير موجود'}</td>
                                <td>${item.quantity}</td>
                                <td>${formatCurrency(item.price, currency)}</td>
                                <td>${formatCurrency(itemTotal, currency)}</td>
                            </tr>
                        `;
                    }).join('')}
                </tbody>
            ...
            <div class="total-section">
                <div class="total-line">الإجمالي: ${formatCurrency(total, currency)}</div>
                ${currency === 'LBP' ? `<div class="total-line">الإجمالي بالدولار: ${formatCurrency(totalUSD, 'USD')}</div>` : ''}
                <div class="total-final">المجموع النهائي: ${formatCurrency(total, currency)}</div>
            </div>
            
            <div class="footer">
                <div>شكراً لكم</div>
                <div>${new Date().toLocaleDateString('ar-SA', { calendar: 'gregory' })} ${new Date().toLocaleTimeString('ar-SA')}</div>
            </div>
        </body>
        </html>
    `;
...
// دالة طباعة فاتورة شراء موجودة
function printExistingPurchaseInvoice(purchaseId) {
    ...
    const printHTML = `
        ...
        <body>
            ...
            <div class="invoice-info">
                <div><strong>رقم الفاتورة:</strong> ${purchase.id}</div>
                <div><strong>التاريخ:</strong> ${new Date(purchase.date).toLocaleDateString('ar-SA', { calendar: 'gregory' })}</div>
                ${purchase.dueDate ? `<div><strong>تاريخ الاستحقاق:</strong> ${new Date(purchase.dueDate).toLocaleDateString('ar-SA', { calendar: 'gregory' })}</div>` : ''}
            </div>
                    ...
                    ${purchase.items.map(item => {
                        ...
                        return `
                            <tr>
                                ...
                                <td>${formatCurrency(itemTotal, purchase.currency)}</td>
                            </tr>
                        `;
                    }).join('')}
                </tbody>
            ...
            <div class="total-section">
                <div class="total-line">الإجمالي: ${formatCurrency(purchase.total, purchase.currency)}</div>
                ${purchase.currency === 'LBP' ? `<div class="total-line">الإجمالي بالدولار: ${formatCurrency(purchase.totalUSD, 'USD')}</div>` : ''}
                <div class="total-final">المجموع النهائي: ${formatCurrency(purchase.total, purchase.currency)}</div>
            </div>
...
function savePurchase(payNow) {
    ...
    showMessage(getText('purchase-invoice-saved'));
}
...
document.querySelectorAll('.nav-item').forEach(item => {
    item.addEventListener('click', function() {
        ...
        // على الموبايل: إغلاق القائمة الجانبية وإخفاء التعتيم بعد الانتقال
        try {
    ...
    if (clearCartBtn) {
        clearCartBtn.addEventListener('click', function() {
            if (confirm(getText('confirm-clear-cart'))) {
                cart = [];
                updateCart();
                showMessage(getText('cart-cleared'), 'success');
            }
        });
    }
...
function displayProducts(searchTerm = '') {
    ...
    filteredProducts.forEach(product => {
        ...
        productCard.onclick = function(e) {
            ...
            addToCart(product);
            showMessage(getText('added-to-cart', { product: product.name }), 'success');
        };
            ...
            <div class="item-info">
                ...
                <div class="inline-edit-price" style="margin-top:4px;display:flex;flex-direction:column;align-items:stretch;gap:6px;">
                    <div class="inline-edit-row" style="display:flex;align-items:center;gap:6px;flex-wrap:nowrap;">
                        <div class="edit-price-field" id="editPriceWrap_${index}" style="display:flex;align-items:center;gap:2px;flex-shrink:0;">
...
function removeFromCart(index) {
    if (index >= 0 && index < cart.length) {
        ...
        if (removedItem && removedItem.name) {
            showMessage(getText('removed-from-cart', { product: removedItem.name }));
        } else {
            showMessage(getText('product-removed-from-cart'));
        }
    }
}
...
document.getElementById('processPayment').addEventListener('click', function() {
    ...
    console.log('🔄 [POS] Saving sale:', newSale);
    // حفظ آمن وموحّد
    secureSaveSale(newSale);
    ...
    // تم نقل تسجيل salesLogs إلى secureSaveSale
    
    // إفراغ العربة وتنظيف الواجهة
    cart = [];
    updateCart();
    
    // تحديث جداول المبيعات والفواتير فوراً إذا كانت الصفحات مفتوحة
    try {
...
function addPreviousAccountToCart() {
    ...
    if (exists) { showMessage(getText('previous-account-exists'), 'warning'); return; }
        cart.push({
    ...
    updateCart();
    showMessage(getText('previous-account-added', { amount: formatCurrency(balance) }), 'success');
...
document.getElementById('clearCart').addEventListener('click', function() {
    cart = [];
    updateCart();
    showMessage(getText('cart-cleared'));
});

// وظائف صفحة الفواتير
function loadInvoices() {
    // حمل أحدث بيانات المبيعات من التخزين قبل رسم الفواتير
    sales = getCurrentSales();
    ...
    invoicesTable.innerHTML = sorted.map(sale => {
        ...
        <tr class="${sale.cancelled ? 'cancelled-row' : ''}">
            ...
            <td>
                ...
                ${!sale.cancelled && !sale.returned && !sale.invoiceNumber.startsWith('RF-') ? `
...
function returnInvoice(invoiceNumber) {
    ...
    // التحقق من أن الفاتورة ليست من نوع مرتجع (RF-)
    // منع إنشاء "Refund Loop" - لا يمكن عمل مرتجع على فاتورة مرتجع
    if (sale.invoiceNumber && sale.invoiceNumber.startsWith('RF-')) {
        showNotification('⚠ لا يمكن عمل مرتجع لفاتورة مرتجع سابق.', 'error');
        return;
    }
...
function filterInvoices() {
    ...
    // تأكد من استخدام أحدث بيانات المبيعات
    sales = getCurrentSales();
...
function generateBarcode() {
    ...
    if (barcodeInput) {
        ...
        // إظهار رسالة نجاح
        showMessage(getText('barcode-generated'), 'success');
    }
}
...
function openPrintBarcode(productId) {
    ...
    document.getElementById('barcodeNumber').textContent = product.barcode || getText('not_specified');
    
    // تحديث ترجمة تسمية الباركود
    const barcodeLabel = document.querySelector('#barcodeProductCode [data-i18n="barcode"]');
    if (barcodeLabel) {
        barcodeLabel.textContent = getText('barcode');
    }
...
function updateBarcodePreview() {
    ...
    if (barcodeNumber && barcodeNumber !== getText('not_specified')) {
        ...
        preview.innerHTML = `<p style="color: #999;">${getText('barcode')}: ${getText('not_specified')}</p>`;
    }
}
...
function printBarcode() {
    ...
    try {
        ...
        if (barcodeNumber === getText('not_specified')) {
            showMessage(getText('barcode') + ' ' + getText('not_specified'), 'error');
            return;
        }
        ...
        showMessage(getText('barcode-printing', { quantity: quantity }), 'success');
        closePrintBarcode();
...
document.getElementById('editProductForm').addEventListener('submit', function(e) {
    ...
    showMessage(getText('product-updated'));
});
...
function updateSuppliersDropdown(selectId) {
    ...
    // If this is the edit product supplier field or purchase supplier field, enhance with a small searchable combo
    if (selectId === 'editProductSupplier' || selectId === 'purchaseSupplier') {
        // ensure we don't duplicate the search UI
        const searchId = selectId === 'purchaseSupplier' ? 'purchaseSupplierSearch' : 'editProductSupplierSearch';
        const listId = selectId === 'purchaseSupplier' ? 'purchaseSupplierList' : 'editProductSupplierList';
        ...
        if (!existingSearch) {
            ...
            function renderSupplierList(filter) {
                ...
                list.innerHTML = '';
                const filtered = suppliers.filter(s => !term || (s.name||'').toLowerCase().includes(term) || (s.phone||'').includes(term));
                filtered.forEach(s => {
                    const item = document.createElement('div');
                    item.innerHTML = `<div style="font-weight: bold;">${s.name}</div><div style="font-size: 0.9em; color: #666;">${s.phone || ''}</div>`;
                    ...
                    item.onclick = () => {
                        ...
                        if (opt) select.value = opt.value; else {
                            const newOpt = document.createElement('option'); newOpt.value = s.id; newOpt.textContent = s.name; select.appendChild(newOpt); select.value = s.id;
                        }
                        inp.value = s.name;
                        // collapse list
                        list.innerHTML = '';
                ...
                if (filtered.length === 0) {
                    const none = document.createElement('div'); none.textContent = (document.documentElement.lang||'ar') === 'en' ? 'No suppliers found' : 'لا يوجد موردون'; none.style.opacity = '0.7'; none.style.padding = '6px 8px'; list.appendChild(none);
                }
            }
            ...
            document.addEventListener('click', function(e){
                if (!e.target.closest('#' + listId) && !e.target.closest('#' + searchId)) {
                    const l = document.getElementById(listId); if (l) l.innerHTML = '';
                }
            });
        }
    }
...
function deleteProduct(id) {
    ...
    if (confirm(getText('confirm-delete-product'))) {
        ...
        showMessage(getText('product-deleted'));
    }
}

// تحميل المبيعات
 function loadSales() {
  // تحميل أحدث نسخة من المبيعات من التخزين قبل العرض لضمان عدم ضياع البيانات
  sales = getCurrentSales();
   ...
   pageItems.forEach(sale => {
        ...
        row.innerHTML = `
            ...
            <td>
                ...
                ${!sale.returned && !sale.invoiceNumber.startsWith('RF-') ? 
...
function viewSale(idOrNumber) {
    ...
    if (sale) {
        ...
        showMessage(getText('invoice-not-found'), 'error');
    }
}
...
document.getElementById('addCustomerForm').addEventListener('submit', function(e) {
    ...
    showMessage(getText('customer-added'));
});
...
document.getElementById('editCustomerForm').addEventListener('submit', function(e) {
    ...
    showMessage(getText('customer-updated'));
});
...
// إصلاح ترتيب عناوين جدول الموردين
function fixSuppliersTableHeaders() {
    const thead = document.querySelector('#suppliers thead tr');
    if (thead) {
        // إزالة جميع العناوين الموجودة
        thead.innerHTML = '';
        
        // إضافة العناوين بالترتيب الصحيح مع الترجمة
        const lang = document.documentElement.lang || 'ar';
        const headers = [
            { key: 'th_supplier_name', ar: 'اسم المورد', en: 'Supplier Name' },
            { key: 'th_phone', ar: 'الهاتف', en: 'Phone' },
            { key: 'th_address', ar: 'العنوان', en: 'Address' },
            { key: 'th_contact_person', ar: 'الشخص المسؤول', en: 'Contact Person' },
            { key: 'th_balance', ar: 'الرصيد المستحق', en: 'Balance Due' },
            { key: 'th_actions', ar: 'الإجراءات', en: 'Actions' }
        ];
        ...
        headers.forEach(header => {
            ...
            th.textContent = lang === 'en' ? header.en : header.ar;
            th.setAttribute('data-i18n', header.key);
            thead.appendChild(th);
        });
        
        console.log('✅ تم إصلاح العناوين نهائياً');
    }
}
...
function loadSuppliers() {
    ...
    // إصلاح العناوين أولاً
    fixSuppliersTableHeaders();
    
    // مسح الجدول بالكامل وإعادة إنشاؤه
    tbody.innerHTML = '';
    console.log('🔄 إعادة تحميل جدول الموردين');
    
    // إنشاء الصفوف بالترتيب الصحيح
    suppliers.forEach(supplier => {
        const row = document.createElement('tr');
        const balance = getSupplierBalanceUSD(supplier.id);
        
        // إنشاء الصفوف بالترتيب الصحيح: اسم المورد، الهاتف، العنوان، الشخص المسؤول، الرصيد، الإجراءات
        row.innerHTML = `
            ...
            <td style="text-align: center;">${formatCurrency(balance, 'USD')}</td>
    ...
    // إصلاح ترتيب العناوين بعد إنشاء الصفوف
    setTimeout(() => {
        fixSuppliersTableHeaders();
    }, 50);
    
    // إصلاح ترتيب العناوين مرة أخرى
    setTimeout(() => {
        fixSuppliersTableHeaders();
    }, 100);
...
document.getElementById('addSupplierForm').addEventListener('submit', function(e) {
    ...
    // إعادة تحميل الجدول لضمان عدم وجود عمود البريد الإلكتروني
    setTimeout(() => {
        loadSuppliers();
        // إزالة إضافية لعمود Email
        const emailTh = document.querySelector('#suppliers thead tr th:nth-child(2)');
        if (emailTh && emailTh.textContent.includes('Email')) {
            emailTh.remove();
            console.log('🗑️ تم حذف عمود Email إضافياً');
        }
    }, 100);
    
    showMessage(getText('supplier-added'));
});
...
document.getElementById('editSupplierForm').addEventListener('submit', function(e) {
    ...
    showMessage(getText('supplier-updated'));
});
...
function deleteSupplier(id) {
    if (confirm(getText('confirm-delete-supplier'))) {
        ...
        updateSuppliersDropdown('editProductSupplier');
        updateSuppliersDropdown('purchaseSupplier');
        showMessage(getText('supplier-deleted'));
    }
}
...
document.getElementById('updateExchangeRate').addEventListener('click', function() {
    ...
    if (newRate > 0) {
        ...
        showMessage(getText('exchange-rate-updated'));
    } else {
...
document.getElementById('overlay').addEventListener('click', function() {
    ...
    // أيضاً: إغلاق قائمة الجوال إن كانت مفتوحة
    try {
        const sb = document.querySelector('.sidebar');
...
document.getElementById('confirmCashMove')?.addEventListener('click', () => {
    ...
    showNotification(getText('cash-move-recorded'), 'success', 2500);
    hideModal('cashMoveModal');
});

// تم نقل جميع event listeners إلى setupReportEventListeners لتجنب التضارب
...
function getRangeByPreset(preset, customFrom, customTo) {
    ...
    switch (preset) {
        ...
        case 'custom':
            ...
            break;
        default:
            // Default to this month if preset is not recognized
            from = new Date(now.getFullYear(), now.getMonth(), 1);
            to = new Date(now.getFullYear(), now.getMonth()+1, 0, 23,59,59,999); 
            break;
    }
...
// تحديد الفلتر المحدد بناءً على النطاق الزمني
function getCurrentPresetFromRange(range) {
    ...
    if (from.getTime() === last7Start.getTime() && to.getTime() === last7End.getTime()) {
        return 'last_7';
    }
    ...
    if (from.getTime() === last30Start.getTime() && to.getTime() === last30End.getTime()) {
        return 'last_30';
    }
    
    // إذا لم يطابق أي فلتر جاهز، فهو مخصص
    return 'custom';
}
...
// تحديث إحصائيات تقرير المبيعات
function updateSalesReportStats(filtered, totalSales, totalTransactions, averageTransaction, todayRevenue) {
    console.log('🔄 تحديث إحصائيات تقرير المبيعات...');
    console.log(`📊 المبيعات المفلترة: ${filtered.length}`);
    console.log(`💰 إجمالي المبيعات: ${totalSales}`);
    console.log(`📈 عدد المعاملات: ${totalTransactions}`);
    console.log(`📊 متوسط المعاملة: ${averageTransaction}`);
    console.log(`📅 مبيعات اليوم: ${todayRevenue}`);
    
    // تحديث الإحصائيات في الواجهة
    const statValues = document.querySelectorAll('.stat-value');
    if (statValues.length >= 4) {
        statValues[0].textContent = formatCurrency(totalSales);
        statValues[1].textContent = totalTransactions;
        statValues[2].textContent = formatCurrency(averageTransaction);
        statValues[3].textContent = formatCurrency(todayRevenue);
    }
    
    // تحديث معلومات الصفحة
    const pageInfo = document.getElementById('salesPageInfo');
    if (pageInfo) {
        pageInfo.textContent = `${getText('showing')} 1-25 ${getText('of')} ${totalTransactions} ${getText('entries')}`;
    }
}

// إعداد event listeners للفلاتر
function setupReportEventListeners() {
    console.log('🔄 إعداد event listeners للفلاتر...');
    ...
    if (presetSelect) {
        presetSelect.addEventListener('change', (e) => {
            ...
            console.log('🔄 تغيير الفلتر إلى:', preset);
            ...
            if (preset !== 'custom') {
                ...
                if (fromInp) fromInp.value = toDateInputValue(from);
                if (toInp) toInp.value = toDateInputValue(to);
                if (fromInp) fromInp.disabled = true;
                if (toInp) toInp.disabled = true;
                
                window.currentReportRange = { from, to };
                console.log('🎯 تم تحديث النطاق الزمني:', { from: from.toISOString(), to: to.toISOString() });
    ...
    if (fromDateInput) {
        fromDateInput.addEventListener('change', () => {
            ...
            if (fromVal && toVal) {
                ...
                window.currentReportRange = { from, to };
                console.log('🎯 تم تحديث النطاق المخصص:', { from: from.toISOString(), to: to.toISOString() });
                setTimeout(() => {
                    applyFilterDirectly();
                }, 100);
            }
    ...
    if (applyBtn) {
        applyBtn.addEventListener('click', () => {
            const preset = document.getElementById('reportPreset')?.value || 'this_month';
            const fromInp = document.getElementById('reportFromDate');
            const toInp = document.getElementById('reportToDate');
            
            console.log('🔄 تطبيق الفلتر:', preset);
            console.log('📅 من:', fromInp?.value);
            console.log('📅 إلى:', toInp?.value);
            
            const { from, to } = getRangeByPreset(preset, fromInp?.value, toInp?.value);
            window.currentReportRange = { from, to };
            
            console.log('🎯 النطاق الزمني المحدد:', {
                from: from.toISOString(),
                to: to.toISOString()
            });
...
// دالة تطبيق التصفية مباشرة
function applySalesFilter() {
    console.log('🔄 تطبيق التصفية...');
    
    if (!window.currentReportRange) {
        console.warn('❌ لا يوجد نطاق زمني محدد');
        return;
    }
    
    const range = window.currentReportRange;
    console.log('🎯 النطاق الزمني:', { from: range.from.toISOString(), to: range.to.toISOString() });
    ...
    console.log(`📊 النتائج: ${filtered.length} من أصل ${sales.length} مبيعات`);
    ...
    // تحديث الواجهة
    updateSalesReportStats(filtered, totalSales, totalTransactions, averageTransaction, 0);
    
    // تحديث الجدول
    updateSalesReportTable(filtered);
    
    // إظهار رسالة للمستخدم
    showMessage(getText('filter-applied', { count: totalTransactions }), 'success');
}

// دالة بسيطة لتطبيق التصفية مباشرة
function applyFilterDirectly() {
    console.log('🔄 تطبيق التصفية مباشرة...');
    
    // الحصول على الفلتر المحدد
    const presetSelect = document.getElementById('reportPreset');
    if (!presetSelect) {
        console.warn('❌ لم يتم العثور على قائمة الفلاتر');
        return;
    }
    
    const preset = presetSelect.value;
    console.log('🎯 الفلتر المحدد:', preset);
    
    // تحديد النطاق الزمني
    const { from, to } = getRangeByPreset(preset);
    window.currentReportRange = { from, to };
    
    console.log('🎯 النطاق الزمني:', { from: from.toISOString(), to: to.toISOString() });
    
    // إضافة console log إضافي لتتبع المشكلة
    ...
    const filtered = sales.filter(s => {
        try {
            ...
            console.warn('❌ خطأ في فحص البيع:', s, error);
            return false;
        }
    });
...
// دالة تحديث جدول تقرير المبيعات
function updateSalesReportTable(filtered) {
    console.log('🔄 تحديث جدول تقرير المبيعات...');
    
    const tbody = document.getElementById('salesReportTableBody');
    if (!tbody) {
        console.warn('❌ لم يتم العثور على جدول تقرير المبيعات');
        return;
    }
    ...
    tbody.innerHTML = filtered.map(sale => `
        <tr style="border-bottom: 1px solid #e5e7eb;">
            <td style="padding: 10px 8px; font-size: 13px; color: #374151;">${sale.invoiceNumber || sale.id || 'N/A'}</td>
            <td style="padding: 10px 8px; font-size: 13px; color: #374151;">${formatDateTime(sale.timestamp || sale.date)}</td>
            <td style="padding: 10px 8px; font-size: 13px; color: #374151;">${sale.customer || sale.customerName || 'عميل عادي'}</td>
            <td style="padding: 10px 8px; font-size: 13px; color: #374151; font-weight: 600;">${formatCurrency(sale.amount || 0)}</td>
            <td style="padding: 10px 8px; font-size: 13px; color: #374151;">${sale.paymentMethod || 'نقدي'}</td>
        </tr>
    `).join('');
    
    console.log(`✅ تم تحديث الجدول بـ ${filtered.length} صف`);
}
function showSalesReport() {
    ...
    // تحديد النطاق الزمني
    let range = window.currentReportRange;
    if (!range) {
        range = getRangeByPreset('this_month');
        window.currentReportRange = range;
    }
    
    console.log('🎯 تطبيق التصفية مع النطاق:', {
    ...
    // تحديد الفلتر المحدد بناءً على النطاق الزمني
    const currentPreset = getCurrentPresetFromRange(range);
    console.log('🎯 الفلتر المحدد:', currentPreset);
    ...
    const toolbar = `
        <div class="report-toolbar" style="margin: 0 15px 20px 15px; padding: 12px 15px; background: #f8f9fa; border-radius: 8px;">
            <div class="filter-group" style="display: flex; gap: 8px; align-items: center;">
                <select id="reportPreset" style="padding: 6px 10px; border: 1px solid #ddd; border-radius: 6px; font-size: 13px; min-width: 120px;">
                    <option value="today" ${currentPreset === 'today' ? 'selected' : ''}>${isEn?'Today':'اليوم'}</option>
                    <option value="this_week" ${currentPreset === 'this_week' ? 'selected' : ''}>${isEn?'This week':'هذا الأسبوع'}</option>
                    <option value="last_7" ${currentPreset === 'last_7' ? 'selected' : ''}>${isEn?'Last 7 days':'آخر 7 أيام'}</option>
                    <option value="this_month" ${currentPreset === 'this_month' ? 'selected' : ''}>${isEn?'This month':'هذا الشهر'}</option>
                    <option value="last_30" ${currentPreset === 'last_30' ? 'selected' : ''}>${isEn?'Last 30 days':'آخر 30 يوم'}</option>
                    <option value="custom" ${currentPreset === 'custom' ? 'selected' : ''}>${isEn?'Custom':'مخصص'}</option>
                </select>
                <input type="date" id="reportFromDate" value="${toDateInputValue(range.from)}" style="${currentPreset === 'custom' ? 'display:block' : 'display:none'}; padding: 6px 10px; border: 1px solid #ddd; border-radius: 6px; font-size: 13px;">
                <input type="date" id="reportToDate" value="${toDateInputValue(range.to)}" style="${currentPreset === 'custom' ? 'display:block' : 'display:none'}; padding: 6px 10px; border: 1px solid #ddd; border-radius: 6px; font-size: 13px;">
            </div>
            <div class="filter-group" style="display: flex; gap: 8px; align-items: center;">
    ...
    setTimeout(() => {
        updateSalesReportStats(filtered, totalSales, totalTransactions, averageTransaction, todayRevenue);
    ...
    setTimeout(() => {
        ...
        console.log('✅ تم إعداد event listeners للفلاتر');
    }, 200);
...
document.getElementById('filterSales').addEventListener('click', function() {
    ...
    // تحميل أحدث بيانات المبيعات من التخزين قبل التصفية لضمان الدقة
    try { sales = loadFromStorage('sales', Array.isArray(sales) ? sales : [] ) || []; } catch(_) {}
    let filteredSales = [...(sales || [])];
    
    // فلترة حسب التاريخ
    if (dateFrom) {
        filteredSales = filteredSales.filter(sale => {
            // تحليل التاريخ/الوقت بشكل متين: استخدم timestamp إن وجد وإلا date
            const raw = sale.timestamp || sale.date;
            let saleDate;
            try {
                if (typeof raw === 'string' && raw.includes('T') && !raw.includes('Z') && !raw.includes('+') && !raw.includes('-', 10)) {
                    const [dPart, tPartRaw] = raw.split('T');
                    const [y, m, d] = dPart.split('-').map(Number);
                    const tPart = tPartRaw.includes('.') ? tPartRaw : `${tPartRaw}.000`;
                    const [timeOnly, ms] = tPart.split('.');
                    const [hh, mm, ss] = timeOnly.split(':').map(Number);
                    saleDate = new Date(y, m - 1, d, hh, mm, ss, Number(String(ms).padEnd(3,'0')));
                } else {
                    saleDate = new Date(raw);
                }
            } catch(_) {
                saleDate = new Date(raw || 0);
            }
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (resetFilterBtn) {
        resetFilterBtn.addEventListener('click', function() {
            ...
            loadSales();
            showMessage(getText('filter-reset'));
        });
    }
});
...
function filterSalesByDate(dateFrom, dateTo) {
    ...
    displayFilteredSales(filteredSales);
    showMessage(getText('transactions-found', { count: filteredSales.length }));
}
...
function searchByBarcode(barcode) {
    ...
    if (product) {
        ...
        showMessage('✅ ' + getText('product-added-by-barcode', { product: product.name }), 'success');
        ...
        showMessage('⚠️ ' + getText('product-not-found-barcode', { barcode: barcode }), 'warning');
    }
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (saveStoreBtn) {
        saveStoreBtn.addEventListener('click', function() {
            ...
            showNotification('✅ ' + getText('store-info-saved'), 'success', 2500);
        });
    }
    ...
    if (showTimeForAllSalesCheckbox) {
        ...
        showTimeForAllSalesCheckbox.addEventListener('change', function() {
            ...
            saveToStorage('settings', settings);
            showMessage(getText('setting-saved'));
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    showMessage(getText('product-added'), 'success');
...
function initiateSaleReturn(saleIdOrNumber) {
    ...
    // التحقق من أن الفاتورة ليست من نوع مرتجع (RF-)
    // منع إنشاء "Refund Loop" - لا يمكن عمل مرتجع على فاتورة مرتجع
    if (currentSaleForReturn.invoiceNumber && currentSaleForReturn.invoiceNumber.startsWith('RF-')) {
        showMessage('⚠ لا يمكن عمل مرتجع لفاتورة مرتجع سابق.', 'error');
        return;
    }
...
function processReturn() {
    ...
    showMessage('✅ ' + getText('sale-returned', { amount: refundText }), 'success');
...
if (menuToggle && sidebar) {
    menuToggle.addEventListener('click', function() {
        ...
        // إظهار طبقة تعتيم عند فتح القائمة على الموبايل
        try {
            if (globalOverlay) {
                if (willOpen) globalOverlay.classList.add('active');
                else globalOverlay.classList.remove('active');
            }
        } catch(_) {}
    });
    ...
    document.addEventListener('click', function(e) {
        if (!sidebar.contains(e.target) && !menuToggle.contains(e.target)) {
            ...
            try { if (globalOverlay) globalOverlay.classList.remove('active'); } catch(_) {}
        }
    });
}
...
(function setupI18n() {
    ...
    if (customersSearchInput) customersSearchInput.placeholder = t.customers_search_placeholder;
        ...
        if (suppliersHead && suppliersHead.length >= 6) {
            ...
            suppliersHead[1].textContent = t.th_phone;
            suppliersHead[2].textContent = t.th_address;
            suppliersHead[3].textContent = t.th_contact_person;
            suppliersHead[4].textContent = t.th_balance;
        ...
        // إصلاح ترتيب عناوين جدول الموردين بعد الترجمة
        setTimeout(() => {
            fixSuppliersTableHeaders();
        }, 50);
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // تحديث قائمة الموردين في نموذج الشراء
    setTimeout(() => {
        updateSuppliersDropdown('purchaseSupplier');
    }, 500);
...
// دالة فتح نموذج إضافة فاتورة شراء (للوصول المباشر)
function openAddPurchaseModal() {
    console.log('🖱️ تم الضغط على زر إضافة فاتورة شراء');
    try {
        showModal('addPurchaseInvoiceModal');
        resetPurchaseForm();
    } catch (error) {
        console.error('خطأ في فتح النافذة:', error);
        alert('خطأ في فتح النافذة. تأكد من أن النظام تم تحميله بالكامل.');
    }
}

// تهيئة مباشرة للزر عند تحميل الصفحة
document.addEventListener('DOMContentLoaded', function() {
    setTimeout(() => {
        const addBtn = document.getElementById('addPurchaseBtn');
        if (addBtn) {
            addBtn.addEventListener('click', openAddPurchaseModal);
            console.log('✅ تم ربط زر إضافة فاتورة شراء مباشرة');
        } else {
            console.warn('❌ لم يتم العثور على زر إضافة فاتورة شراء');
        }
        
                // إصلاح ترتيب العناوين عند تحميل الصفحة
                fixSuppliersTableHeaders();
...
// تهيئة إضافية للزر عند تحميل الصفحة
window.addEventListener('load', function() {
    setTimeout(() => {
        const addBtn = document.getElementById('addPurchaseBtn');
        if (addBtn) {
            addBtn.addEventListener('click', openAddPurchaseModal);
            console.log('✅ تم ربط زر إضافة فاتورة شراء عند تحميل الصفحة');
        }
    }, 500);
});
...
// متغيرات نظام المشتريات
let purchaseInvoices = loadFromStorage('purchaseInvoices', []);

// تهيئة نظام المشتريات
function initPurchasesSystem() {
    loadPurchases();
    setupPurchasesEventListeners();
    populatePurchaseSuppliers();
    populatePurchaseProducts();
}

// معالج الضغط على زر إضافة فاتورة شراء
function handleAddPurchaseClick() {
    console.log('🖱️ تم الضغط على زر إضافة فاتورة شراء');
    showModal('addPurchaseInvoiceModal');
    resetPurchaseForm();
}
...
function loadPurchases() {
    ...
    const sortedPurchases = [...purchaseInvoices].sort((a, b) => new Date(b.timestamp) - new Date(a.timestamp));
    ...
    tbody.innerHTML = sortedPurchases.map(purchase => `
        <tr>
            ...
            <td>${formatDateTime(purchase.timestamp)}</td>
            <td>
                <button class="action-btn print-btn" onclick="printPurchaseInvoice('${purchase.id}')" title="طباعة">
...
// إعداد event listeners للمشتريات
function setupPurchasesEventListeners() {
    // زر إضافة فاتورة شراء
    const addBtn = document.getElementById('addPurchaseBtn');
    if (addBtn) {
        // إزالة event listeners القديمة أولاً
        addBtn.removeEventListener('click', openAddPurchaseModal);
        // إضافة event listener جديد
        addBtn.addEventListener('click', openAddPurchaseModal);
        console.log('✅ تم ربط زر إضافة فاتورة شراء');
    } else {
        console.warn('❌ لم يتم العثور على زر إضافة فاتورة شراء');
    }
    
    // نموذج إضافة فاتورة شراء
    const form = document.getElementById('addPurchaseInvoiceForm');
    if (form) {
        form.addEventListener('submit', handlePurchaseFormSubmit);
    }
    
    // تحديث الإجمالي عند تغيير الكميات أو الأسعار
    document.addEventListener('input', (e) => {
        if (e.target.classList.contains('purchase-quantity') || e.target.classList.contains('purchase-cost')) {
            updatePurchaseSubtotal(e.target);
            updatePurchaseTotal();
        }
    });
}

// ملء قائمة الموردين في نموذج الشراء
function populatePurchaseSuppliers() {
    const select = document.getElementById('purchaseSupplier');
    if (!select) return;
    
    const suppliers = loadFromStorage('suppliers', []);
    const selectSupplierText = getText('select-supplier');
    select.innerHTML = `<option value="">${selectSupplierText}</option>` + 
        suppliers.map(s => `<option value="${s.id}">${s.name}</option>`).join('');
    
    // تحديث ترجمة الخيار الأول
    const firstOption = select.querySelector('option[value=""]');
    if (firstOption) {
        firstOption.setAttribute('data-i18n', 'select-supplier');
        firstOption.textContent = selectSupplierText;
    }
}

// ملء قائمة المنتجات في نموذج الشراء
function populatePurchaseProducts() {
    ...
    const selectProductText = getText('select-product');
    
    selects.forEach(select => {
        if (select.children.length <= 1) { // فقط إذا كان فارغاً
            select.innerHTML = `<option value="" data-i18n="select-product">${selectProductText}</option>` + 
                products.map(p => `<option value="${p.id}">${p.name}</option>`).join('');
        }
    });
}

// إضافة صنف جديد في نموذج الشراء
function addPurchaseItem() {
    const container = document.querySelector('.purchase-items-container');
    if (!container) return;
    
    const selectProductText = getText('select-product');
    const quantityText = getText('quantity');
    const costPerUnitText = getText('cost-per-unit');
    
    const newRow = document.createElement('div');
    newRow.className = 'purchase-item-row';
    newRow.innerHTML = `
        <select class="purchase-product" required>
            <option value="" data-i18n="select-product">${selectProductText}</option>
        </select>
        <input type="number" class="purchase-quantity" data-i18n-placeholder="quantity" placeholder="${quantityText}" min="1" required>
        <input type="number" class="purchase-cost" data-i18n-placeholder="cost-per-unit" placeholder="${costPerUnitText}" min="0" step="0.01" required>
        <span class="purchase-subtotal">0.00</span>
        <button type="button" class="remove-purchase-item" onclick="removePurchaseItem(this)">
...
// تحديث الإجمالي الفرعي للصنف
function updatePurchaseSubtotal(input) {
    ...
    row.querySelector('.purchase-subtotal').textContent = subtotal.toFixed(2);
}

// تحديث الإجمالي الكلي للفاتورة
function updatePurchaseTotal() {
    const subtotals = document.querySelectorAll('.purchase-subtotal');
    const total = Array.from(subtotals).reduce((sum, element) => {
        return sum + parseFloat(element.textContent) || 0;
    }, 0);
    
    const totalElement = document.getElementById('purchaseTotalAmount');
    if (totalElement) {
        totalElement.textContent = total.toFixed(2);
    }
}

// إعادة تعيين نموذج الشراء
...
function handlePurchaseFormSubmit(e) {
    ...
    if (!supplierId) {
        showMessage('يرجى اختيار مورد', 'error');
        return;
    }
    ...
    for (let row of rows) {
        ...
        const quantity = parseFloat(row.querySelector('.purchase-quantity').value);
        const cost = parseFloat(row.querySelector('.purchase-cost').value);
    ...
    const purchaseInvoice = {
        id: generateInvoiceId(),
        invoiceNumber: `PR-${String(purchaseInvoices.length + 1).padStart(4, '0')}`,
        supplierId: supplierId,
        supplierName: suppliers.find(s => s.id === supplierId)?.name || 'غير محدد',
        items: items,
        total: total,
    ...
    saveToStorage('purchaseInvoices', purchaseInvoices);
    
    // تحديث الواجهة
    loadPurchases();
    hideModal('addPurchaseInvoiceModal');
    
    showMessage(getText('purchase-invoice-created', { invoice: purchaseInvoice.invoiceNumber }), 'success');
}

// طباعة فاتورة الشراء
function printPurchaseInvoice(purchaseId) {
    const purchase = purchaseInvoices.find(p => p.id === purchaseId);
    if (!purchase) {
        showMessage('فاتورة الشراء غير موجودة', 'error');
        return;
    }
    
    // إنشاء محتوى الطباعة
    const printContent = generatePurchasePrintContent(purchase);
    
    // طباعة
    printReceipt(printContent);
}

// إنشاء محتوى طباعة فاتورة الشراء
function generatePurchasePrintContent(purchase) {
    const storeName = settings.storeName || 'المتجر';
    const storeAddress = settings.storeAddress || '';
    const now = new Date();
    const dateTime = formatDateTime(purchase.timestamp);
    
    let content = `
        <div style="text-align: center; font-family: 'Courier New', monospace; font-size: 14px; max-width: 300px; margin: 0 auto;">
            <h2 style="margin: 0; font-size: 18px; font-weight: bold;">${storeName}</h2>
            ${storeAddress ? `<p style="margin: 5px 0; font-size: 12px;">${storeAddress}</p>` : ''}
            <hr style="border: 1px dashed #000; margin: 10px 0;">
            
            <h3 style="margin: 10px 0; font-size: 16px;">فاتورة شراء</h3>
            <p style="margin: 5px 0;"><strong>رقم الفاتورة:</strong> ${purchase.invoiceNumber}</p>
            <p style="margin: 5px 0;"><strong>المورد:</strong> ${purchase.supplierName}</p>
            <p style="margin: 5px 0;"><strong>التاريخ:</strong> ${dateTime}</p>
            ...
            <table style="width: 100%; border-collapse: collapse; margin: 10px 0;">
                <thead>
                    <tr style="border-bottom: 1px solid #000;">
                        <th style="text-align: right; padding: 5px; font-size: 12px;">الصنف</th>
                        <th style="text-align: center; padding: 5px; font-size: 12px;">الكمية</th>
                        <th style="text-align: center; padding: 5px; font-size: 12px;">السعر</th>
                        <th style="text-align: center; padding: 5px; font-size: 12px;">المجموع</th>
                    </tr>
                </thead>
                <tbody>
    `;
    ...
    purchase.items.forEach(item => {
        content += `
            <tr style="border-bottom: 1px dashed #ccc;">
                <td style="text-align: right; padding: 3px; font-size: 11px;">${item.productName}</td>
                <td style="text-align: center; padding: 3px; font-size: 11px;">${item.quantity}</td>
                <td style="text-align: center; padding: 3px; font-size: 11px;">${item.cost.toFixed(2)}</td>
                <td style="text-align: center; padding: 3px; font-size: 11px;">${item.subtotal.toFixed(2)}</td>
            </tr>
        `;
    });
    ...
    content += `
            ...
            ${purchase.notes ? `
                <hr style="border: 1px dashed #000; margin: 10px 0;">
                <p style="margin: 5px 0; font-size: 11px;"><strong>ملاحظات:</strong></p>
                <p style="margin: 5px 0; font-size: 11px; text-align: right;">${purchase.notes}</p>
            ` : ''}
            
            <hr style="border: 1px dashed #000; margin: 10px 0;">
            
            <p style="margin: 10px 0; font-size: 10px; text-align: center;">
...
document.addEventListener('DOMContentLoaded', function() {
    // تهيئة نظام المشتريات فوراً
    initPurchasesSystem();
});

// تهيئة إضافية عند تبديل الصفحات
document.addEventListener('click', function(e) {
    if (e.target.closest('[data-screen="purchases"]')) {
        setTimeout(() => {
            initPurchasesSystem();
            // تهيئة مباشرة للزر
            const addBtn = document.getElementById('addPurchaseBtn');
            if (addBtn) {
                addBtn.addEventListener('click', openAddPurchaseModal);
                console.log('✅ تم ربط زر إضافة فاتورة شراء عند تبديل الصفحة');
            }
        }, 100);
    }
    
                        // إصلاح ترتيب العناوين عند الذهاب لصفحة الموردين
                        if (e.target.closest('[data-screen="suppliers"]')) {
                            setTimeout(() => {
                                // إصلاح ترتيب العناوين عند تبديل الصفحة
                                fixSuppliersTableHeaders();
                                
                                // إعادة تحميل الجدول لضمان الترتيب الصحيح
                                loadSuppliers();
